...
public class ToggleButton extends View{
    ...
    private int onColor = R.color.colorAccent;
    private int offBorderColor = R.color.colorPrimary;
    private int offColor = R.color.colorPrimary;
    private int spotColor = R.color.colorPrimaryDark;
    private int borderColor = offBorderColor;  //borderColor not used!
    private Paint paint ;
